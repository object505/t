    ...
    <div className="grid gap-4 md:grid-cols-2">
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <label className="text-sm font-medium text-muted-foreground mb-4">Markdown</label>
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="min-h-[340px] rounded-lg border border-border p-4 prose prose-sm dark:prose-invert overflow-y-auto scrollbar-thin">
